    ...
    value: function render() {
      ...
      if (allPages <= 5 + pageBufferSize * 2) {
        ...
        for (var i = 1; i <= allPages; i++) {
          ...
          pagerList.push(_react2['default'].createElement(_Pager2['default'], (0, _extends3['default'])({}, pagerProps, { key: i, page: i, active: active })));
        }
      } else {
      ...
      return _react2['default'].createElement(
        ...
        null,
        totalText,
        props.hideOnSinglePage && (props.total >= this.state.pageSize || props.total >= props.defaultPageSize) && _react2['default'].createElement(
          _react2['default'].Fragment,
          null,
