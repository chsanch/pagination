    ...
    value: function render() {
      ...
      if (allPages <= 5 + pageBufferSize * 2) {
        ...
        for (var i = 1; i <= allPages; i++) {
          ...
          pagerList.push(React.createElement(Pager, _extends({}, pagerProps, { key: i, page: i, active: active })));
        }
      } else {
      ...
      return React.createElement(
        ...
        null,
        totalText,
        props.hideOnSinglePage && (props.total >= this.state.pageSize || props.total >= props.defaultPageSize) && React.createElement(
          React.Fragment,
          null,
